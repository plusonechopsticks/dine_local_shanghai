...
import { bookings, hostListings } from "./drizzle/schema.js";
import { eq } from "drizzle-orm";
import { generateHostNotificationEmail } from "./server/email-templates.js";
import { sendEmail } from "./server/email.js";

async function sendHostNotificationForBooking(bookingId) {
  try {
