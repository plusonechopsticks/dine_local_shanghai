...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* OPTION B MOCKUP: Find Us On — platform section */}
      <section className="py-16 bg-white border-t border-gray-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <p className="text-center text-xs font-semibold tracking-widest text-gray-400 uppercase mb-3">Also find us on</p>
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">Book &amp; Follow Along</h2>
          <p className="text-center text-gray-500 mb-12 max-w-xl mx-auto">
            Book through your favourite travel platform, or follow us for behind-the-scenes glimpses of home dining in Shanghai.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a
              ...
              className="group flex flex-col items-center gap-4 p-8 rounded-2xl border-2 border-gray-100 hover:border-[#FF5533] hover:shadow-lg transition-all duration-200 bg-white"
            >
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: '#FF5533' }}>
                <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-9 h-9">
                  <circle cx="20" cy="20" r="20" fill="#FF5533"/>
                  <text x="50%" y="55%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="18" fontWeight="bold" fontFamily="Arial">G</text>
                </svg>
              </div>
              <div className="text-center">
                <p className="font-bold text-gray-900 text-lg group-hover:text-[#FF5533] transition">GetYourGuide</p>
                <p className="text-sm text-gray-500 mt-1">Book our experiences on the world's largest activities platform</p>
              </div>
              <span className="mt-auto text-sm font-semibold text-[#FF5533] group-hover:underline">Book Now →</span>
            </a>

            {/* Instagram */}
            <a
              href="https://www.instagram.com/plus1chopsticks"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center gap-4 p-8 rounded-2xl border-2 border-gray-100 hover:border-pink-500 hover:shadow-lg transition-all duration-200 bg-white"
            >
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)' }}>
              ...
              <div className="text-center">
                <p className="font-bold text-gray-900 text-lg group-hover:text-pink-500 transition">Instagram</p>
                <p className="text-sm text-gray-500 mt-1">Behind-the-scenes, host stories &amp; food photos</p>
              </div>
              <span className="mt-auto text-sm font-semibold text-pink-500 group-hover:underline">Follow Us →</span>
            </a>

            {/* TikTok */}
            <a
              href="https://www.tiktok.com/@plus1chopsticks"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center gap-4 p-8 rounded-2xl border-2 border-gray-100 hover:border-gray-900 hover:shadow-lg transition-all duration-200 bg-white"
            >
              ...
              <div className="text-center">
                <p className="font-bold text-gray-900 text-lg group-hover:text-gray-700 transition">TikTok</p>
                <p className="text-sm text-gray-500 mt-1">Short videos of real home dining moments in Shanghai</p>
              </div>
              <span className="mt-auto text-sm font-semibold text-gray-900 group-hover:underline">Follow Us →</span>
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              {/* OPTION A: social icons in footer */}
              <div className="flex items-center gap-3">
                <a href="https://www.instagram.com/plus1chopsticks" target="_blank" rel="noopener noreferrer"
                ...
                <a href="https://www.tiktok.com/@plus1chopsticks" target="_blank" rel="noopener noreferrer"
                  className="w-8 h-8 rounded-full flex items-center justify-center bg-white/10 hover:bg-white/20 transition"
                  title="TikTok">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-4 h-4">
                    <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.52V6.76a4.85 4.85 0 01-1.01-.07z"/>
                ...
                <a href="https://www.getyourguide.com" target="_blank" rel="noopener noreferrer"
                  className="w-8 h-8 rounded-full flex items-center justify-center bg-white/10 hover:bg-white/20 transition text-white text-xs font-bold"
                  title="GetYourGuide">
                  G
                </a>
              </div>
