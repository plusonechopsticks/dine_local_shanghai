...
const FEATURED_HOST_GROUPS = [
  ["Jiading Ayi", "Norika and Steven", "Chuan"], // Group 1
  ["Eating", "Echo Ren", "Grace Tong"], // Group 2
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 mt-1">
                {/* Instagram */}
                <a href="https://www.instagram.com/plus1chopsticks?igsh=NTc4MTIwNjQ2YQ%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer"
                ...
                {/* Rednote (小红书) */}
                <a href="https://xhslink.com/m/ArmBkqpZDTl" target="_blank" rel="noopener noreferrer"
                  className="w-9 h-9 rounded-full flex items-center justify-center bg-white/10 hover:bg-white/20 transition"
                  title="Rednote (小红书)">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-4 h-4">
                    <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm4.5 7.5h-2v1h2v1h-2v1h2v1h-3.5V8H16.5v1.5zm-5 4.5H10V8h1.5v6zm-3-6H7v6h1.5V8z"/>
                  </svg>
                </a>
                {/* GetYourGuide certified badge */}
                <a href="https://www.getyourguide.com/-s714273" target="_blank" rel="noopener noreferrer" title="Book on GetYourGuide">
                  <img src="https://gyg.me/kUtga42u" width="80px" height="auto" style={{ border: '1px solid #4a5568', borderRadius: '4px', opacity: 0.85 }} alt="GetYourGuide | +1 Chopsticks" />
                </a>
              </div>
            </div>
