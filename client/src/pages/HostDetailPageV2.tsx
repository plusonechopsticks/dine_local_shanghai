...
export default function HostDetailPageV2() {
  ...
  if (!hostId) {
    return <div className="container py-20 text-center">Invalid host ID</div>;
  }

  if (isLoading) {
    return <div className="container py-20 text-center">Loading host details...</div>;
  }

  if (error || !host) {
    return <div className="container py-20 text-center">Host not found</div>;
  }
  ...
  return (
    <div className="bg-[#faf8f3] text-[#1a1410]">
      ...
      <div className="fixed right-12 top-32 w-80 bg-white border border-[#e8e3d8] rounded-sm shadow-lg z-30 max-h-[calc(100vh-160px)] overflow-y-auto">
        {/* Widget Header */}
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="border-t border-[#e8e3d8] pt-4">
            ...
            <button
              ...
              className="w-full bg-[#c44536] text-white py-3 rounded-sm text-xs tracking-widest uppercase font-medium hover:bg-[#a83a2d] transition disabled:opacity-50"
            >
