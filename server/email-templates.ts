...
/**
 * Generate host interest outreach email (sent automatically when someone submits the host interest form)
 * Template: Steven's personalised "let's chat" email
 */
export function generateHostInterestOutreachEmail(data: { name: string }): string {
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Hosting with +1 Chopsticks</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f5f5; padding: 40px 20px;">
    <tr>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px 40px 32px 40px;">
              <p style="margin: 0 0 16px 0; color: #1f2937; font-size: 16px; line-height: 1.7;">Hi <strong>${firstName}</strong>,</p>

              <p style="margin: 0 0 16px 0; color: #1f2937; font-size: 16px; line-height: 1.7;">
                Thanks so much for your interest in hosting with +1 Chopsticks — really excited to connect!
              </p>

              <p style="margin: 0 0 16px 0; color: #1f2937; font-size: 16px; line-height: 1.7;">
                We'd love to schedule a quick chat to learn more about you and walk you through how everything works. We can do WeChat or Zoom, whichever is easier for you — just let me know your availability and I'll get something set up.
              </p>

              <p style="margin: 0 0 32px 0; color: #1f2937; font-size: 16px; line-height: 1.7;">
                Looking forward to speaking soon!
              </p>

              <p style="margin: 0 0 4px 0; color: #1f2937; font-size: 16px; line-height: 1.7;">Cheers,</p>
              <p style="margin: 0 0 4px 0; color: #1f2937; font-size: 16px; font-weight: 600; line-height: 1.7;">Steven</p>
              <p style="margin: 0 0 4px 0; color: #6b7280; font-size: 14px; line-height: 1.7;">Founder &amp; CEO, +1 Chopsticks</p>

              <p style="margin: 24px 0 0 0; color: #6b7280; font-size: 14px; line-height: 1.7;">
                P.S. My WeChat FYI: <strong>Stevento-Kellogg</strong>
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 24px 40px; text-align: center; border-top: 1px solid #e5e7eb;">
              <p style="margin: 0 0 8px 0; color: #9ca3af; font-size: 12px;">
                <a href="https://plus1chopsticks.com" style="color: #7c2d12; text-decoration: none;">plus1chopsticks.com</a>
              </p>
              <p style="margin: 0; color: #9ca3af; font-size: 12px;">
                © 2026 +1 Chopsticks | Authentic Chinese Home Dining Experience
              </p>
